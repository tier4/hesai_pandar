...
public:
  ...
  Pandar40Decoder(Calibration& calibration, float scan_phase = 0.0f,  float min_range = 0.0f, float max_range = 0.0f, double dual_return_distance_threshold = 0.1, ReturnMode return_mode = ReturnMode::DUAL);
